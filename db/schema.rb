...
ActiveRecord::Schema.define(version: 20160119125923) do
  ...
  create_table "spree_banner_types", force: :cascade do |t|
    t.string   "name"
  ...
  add_index "spree_banners", ["type_id"], name: "index_spree_banners_on_type_id", using: :btree
  ...
  create_table "spree_devices", force: :cascade do |t|
  ...
  add_index "spree_filters", ["type", "name"], name: "index_spree_filters_on_type_and_name", using: :btree
  ...
  add_index "spree_taxons", ["suggestable"], name: "index_spree_taxons_on_suggestable", using: :btree
